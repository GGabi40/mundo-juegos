...
const images: Image = {
  ...
  "classic": ['Clásicos', 'images/categories/classic.webp'],
  ...
  "card": ['Cartas', 'images/categories/cards.webp'],
  "sports": ['Deportes', 'images/categories/sports.webp'],
  "gun": ['Armas', 'images/categories/guns.webp'],
  "kitchen": ['Cocina', 'images/categories/kitchen.webp'],
  "racing": ['Carreras', 'images/categories/rides.webp'],
  "cars": ['Autos', 'images/categories/driving.webp'],
  "bike": ['Motos', 'images/categories/bikes.webp'],
  "fashion": ['Moda', 'images/categories/fashion.webp'],
  "escape": ['Escape', 'images/categories/scape.webp'],
